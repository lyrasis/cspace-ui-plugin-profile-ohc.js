...
export default {
  forms: {
    ...
    messages: defineMessages({
      ...
      pellet: {
        id: 'option.forms.pellet',
        defaultMessage: 'pellet',
      },
      // pinned message is already configured in cspace-ui.
      'pressed plant': {
        id: 'option.forms.pressed plant',
        defaultMessage: 'pressed plant',
      },
      replica: {
        id: 'option.forms.replica',
        defaultMessage: 'replica',
      },
      rock: {
        id: 'option.forms.rock',
        defaultMessage: 'rock',
      },
      seeds: {
        id: 'option.forms.seeds',
        defaultMessage: 'seeds',
      },
      shell: {
        id: 'option.forms.shell',
        defaultMessage: 'shell',
      },
      skeletal: {
        id: 'option.forms.skeletal',
        defaultMessage: 'skeletal',
      },
      slide: {
        id: 'option.forms.slide',
        defaultMessage: 'slide',
      },
      'study skin': {
        id: 'option.forms.study skin',
        defaultMessage: 'study skin',
      },
      'tanned hide': {
  ...
  numberTypes: {
    values: [
      ...
      'Barcode Number',
      'Community NID',
      'Digital Heritage Collection NID',
      'Digital Heritage Item NID',
      'Field Sheet Number',
